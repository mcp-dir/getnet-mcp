...
Getnet segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Getnet** | BR | Payment acquirer API provider (provedor dos dados do usuário) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [getnet@mcp.ai](mailto:getnet@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
